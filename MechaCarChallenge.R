...
############ Deliverable 3 #################
# Step 1
# In your MechaCarChallenge.RScript, write an RScript 
# using the t.test() function to determine if the PSI 
# across all manufacturing lots is statistically different 
# from the population mean of 1,500 pounds per square inch.
t.test(Suspension_Coil$PSI,mu=mean(Suspension_Coil$PSI))
# Step 2
# Next, write three more RScripts in your 
# MechaCarChallenge.RScript using the t.test() function 
# and its subset() argument to determine if the PSI for 
# each manufacturing lot is statistically different from 
